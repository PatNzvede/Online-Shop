    ...
    public class CartsController : ControllerBase
    {
        ...
        public async Task<ActionResult> PostCart(List<Product> cart)
        {
            ...
            if (c != null && c.OrderId != "001")
            {
                ...
                var dtt = DateTime.Today.ToString("yyyyMMdd");
            ...
            var message = new Message(new string[] { name }, 
                $"Thanks for order {code}", $"Dear {name} ,<br/> <br/> Thank you for the purchase of R{ss}." +
                $" It was good doing business with you ,<br/> <br/> Please call again. <br/> Tested Online Shop", null);
